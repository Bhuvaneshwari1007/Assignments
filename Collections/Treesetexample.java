...
class Treesetexample {
    public static void main(String[] args) {
        ...
        Employee1 t1 = new Employee1(1, "Ram", "Testing", 10000);
        Employee1 t2 = new Employee1(2, "Bhuv", "Developer", 20000);
        Employee1 t3 = new Employee1(3, "Caroll", "Support", 30000);
        Employee1 t4 = new Employee1(4, "Daniel", "Testing", 40000);
        Employee1 t5 = new Employee1(11, "Ishwarya", "cleaning", 50000);
        Employee1 t6 = new Employee1(6, "Harini", "Administration", 60000);
        Employee1 t7 = new Employee1(7, "Juhi", "Catering", 70000);
        Employee1 t8 = new Employee1(8, "Gayathri", "Designing", 80000);
        Employee1 t9 = new Employee1(9, "Ishaan", "Associate", 1000);
        Employee1 t10 = new Employee1(10, "Akash", "Medical support", 100000);
